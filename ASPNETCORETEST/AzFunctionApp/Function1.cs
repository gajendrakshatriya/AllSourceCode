...
namespace AzFunctionApp
{
    public static class Function1
    {
        ...
        //[QueueTrigger("sbus-queue-1", Connection = "AzureWebJobsServiceBus")] string myQueueItem,
        //ILogger log)
        //{
        ...
        public static void Run(
        [ServiceBusTrigger("sbus-queue-1", Connection = "ServiceBusConnection")] Message message,
        ILogger log)
        {
